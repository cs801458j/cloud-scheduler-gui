                ...
                <section className={Style.content}>
                    ...
                    <div className={Style.bottom}>
                        <div className={Style.left}>
                            <div className={Style.time}>{this.props.ResourceContainer.state.description}</div>
                            <div className={Style.date}>{this.props.ResourceContainer.state.description}</div>
                        </div>
                        <div className={Style.right}>
                            <div className={Style.width}>
                                <h2>Content</h2>
                                <form onSubmit={this.handleSubmit}>
                                    <lable>site_id:<input type='text' name='site_id' value={this.state.site_id} onChange={this.handleInputChange}/>
                                    </lable>
                                    <br/>
                                    <label>name:<input type='text' name='_name'value={this.state._name} onChange={this.handleInputChange} />
                                    </label>
                                    <br/>
                                    <label>description:<input type='text' name='description' value={this.state.description} onChange={this.handleInputChange}/>
                                    </label>
                                    <br/>
                                    <label>contact:<input type='text' name='contact' value={this.state.contact} onChange={this.handleInputChange}/>
                                    </label>
                                    <br/>
